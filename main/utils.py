...
def get_header():
    ...
    with open('main/logindata.json', 'r', encoding='utf-8') as file:
        login = json.load(file)
        if len(login) < 1:
            logger.info("logindata.json is empty")
            return {}
    ...
    logger.error("No matching admin user.")
    return{}
...
def admin_login_json():
    ...
    logger.info("main/logindata.json populated:")
